...
/**
 * The DAO class for the Clasediagnostico entity.
 */
@Repository
public class ClaseDiagnosticoDAOImpl implements IClaseDiagnosticoDao {
	...
	public Clasediagnostico findClasediagnosticoById(long id) {
		return (Clasediagnostico)em.find(Clasediagnostico.class, new Long(id));
	}
	/**
	...
	public void persistClasediagnostico(Clasediagnostico clasediagnostico) {
		em.persist(em.merge(clasediagnostico));
	}
	/**
	...
	public void removeClasediagnostico(Clasediagnostico clasediagnostico) {
		...
		em.remove(em.merge(clasediagnostico));
	}
}