...
/**
 * The DAO class for the Codigoenfermedade entity.
 */
@Repository
public class CodigoEnfermedadesDAOImpl implements ICodigoEnfermedadesDao {
    @PersistenceContext
    private EntityManager em;

	public CodigoEnfermedadesDAOImpl() {
		super();
	}
	/**
	...
	public Codigoenfermedade findCodigoenfermedadeById(long id) {
		return (Codigoenfermedade)em.find(Codigoenfermedade.class, new Long(id));
	}
	/**
	...
	public void persistCodigoenfermedade(Codigoenfermedade codigoenfermedade) {
		em.persist(em.merge(codigoenfermedade));
	}
	/**
	...
	public void removeCodigoenfermedade(Codigoenfermedade codigoenfermedade) {
		...
		em.remove(em.merge(codigoenfermedade));
	}
}