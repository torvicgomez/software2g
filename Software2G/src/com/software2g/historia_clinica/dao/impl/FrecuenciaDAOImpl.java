...
/**
 * The DAO class for the Frecuencia entity.
 */
@Repository
public class FrecuenciaDAOImpl implements IFrecuenciaDao {
    @PersistenceContext
	...
	public Frecuencia findFrecuenciaById(long id) {
		return (Frecuencia)em.find(Frecuencia.class, new Long(id));
	}
	/**
	...
	public List<Frecuencia> findAllFrecuencias() {
        try {
    		String jpqlString = "select frecuencia from " + Frecuencia.class.getSimpleName() + " frecuencia";
	...
	public void persistFrecuencia(Frecuencia frecuencia) {
		em.persist(em.merge(frecuencia));
	}
	/**
