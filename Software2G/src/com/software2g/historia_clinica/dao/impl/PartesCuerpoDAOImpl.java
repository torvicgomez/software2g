...
/**
 * The DAO class for the Partescuerpo entity.
 */
@Repository
public class PartesCuerpoDAOImpl implements IPartesCuerpoDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgresOptica")
    private EntityManager em;

	public PartesCuerpoDAOImpl() {
		super();
	}
	/**
	...
	public Partescuerpo findPartescuerpoById(long id) {
		return (Partescuerpo)em.find(Partescuerpo.class, new Long(id));
	}
	/**
	...
	public List<Partescuerpo> findAllPartescuerpos() {
        try {
    		String jpqlString = "select partescuerpo from " + Partescuerpo.class.getSimpleName() + " partescuerpo";
	...
	public void persistPartescuerpo(Partescuerpo partescuerpo) {
		em.persist(em.merge(partescuerpo));
	}
	/**
