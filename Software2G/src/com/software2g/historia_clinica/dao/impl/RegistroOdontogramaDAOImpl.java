...
/**
 * The DAO class for the Registroodontograma entity.
 */
@Repository
public class RegistroOdontogramaDAOImpl implements IRegistroOdontogramaDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgres")
    private EntityManager em;

	public RegistroOdontogramaDAOImpl() {
		super();
	}
	/**
	...
	public Registroodontograma findRegistroodontogramaById(long id) {
		return (Registroodontograma)em.find(Registroodontograma.class, new Long(id));
	}
	/**
	...
	public List<Registroodontograma> findAllRegistroodontogramas() {
        try {
    		String jpqlString = "select registroodontograma from " + Registroodontograma.class.getSimpleName() + " registroodontograma";
	...
	public void persistRegistroodontograma(Registroodontograma registroodontograma) {
		em.persist(em.merge(registroodontograma));
	}
	/**
	...
	public void removeRegistroodontograma(Registroodontograma registroodontograma) {
		...
		em.remove(em.merge(registroodontograma));
	}
}