...
/**
 * The DAO class for the Seccionodon entity.
 */
@Repository
public class SeccionOdonDAOImpl implements ISeccionOdonDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgres")
    private EntityManager em;

	public SeccionOdonDAOImpl() {
		super();
	}
	/**
	...
	public Seccionodon findSeccionodonById(long id) {
		return (Seccionodon)em.find(Seccionodon.class, new Long(id));
	}
	/**
	...
	public List<Seccionodon> findAllSeccionodons() {
        try {
    		String jpqlString = "select seccionodon from " + Seccionodon.class.getSimpleName() + " seccionodon";
	...
	public void persistSeccionodon(Seccionodon seccionodon) {
		em.persist(em.merge(seccionodon));
	}
	/**
	...
	public void removeSeccionodon(Seccionodon seccionodon) {
		...
		em.remove(em.merge(seccionodon));
	}
}