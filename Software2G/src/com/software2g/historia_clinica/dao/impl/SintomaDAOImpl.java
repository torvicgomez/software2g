...
/**
 * The DAO class for the Sintoma entity.
 */
@Repository
public class SintomaDAOImpl implements ISintomaDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgresOptica")
    private EntityManager em;

	public SintomaDAOImpl() {
		super();
	}
	/**
	...
	public Sintoma findSintomaById(long id) {
		return (Sintoma)em.find(Sintoma.class, new Long(id));
	}
	/**
	...
	public List<Sintoma> findAllSintomas() {
        try {
    		String jpqlString = "select sintoma from " + Sintoma.class.getSimpleName() + " sintoma";
