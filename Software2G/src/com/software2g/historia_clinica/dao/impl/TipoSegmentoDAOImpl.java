...
/**
 * The DAO class for the Tiposegmento entity.
 */
@Repository
public class TipoSegmentoDAOImpl implements ITipoSegmentoDao {
	...
	public Tiposegmento findTiposegmentoById(long id) {
		return (Tiposegmento)em.find(Tiposegmento.class, new Long(id));
	}
	/**
	...
	public List<Tiposegmento> findAllTiposegmentos() {
        try {
    		String jpqlString = "select tiposegmento from " + Tiposegmento.class.getSimpleName() + " tiposegmento";
	...
	public void persistTiposegmento(Tiposegmento tiposegmento) {
		em.persist(em.merge(tiposegmento));
	}
	/**
	...
	public void removeTiposegmento(Tiposegmento tiposegmento) {
		...
		em.remove(em.merge(tiposegmento));
	}
}