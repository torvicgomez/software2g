...
/**
 * The DAO class for the Tiposervicio entity.
 */
@Repository
public class TipoServicioDAOImpl implements ITipoServicioDao {
	...
	public Tiposervicio findTiposervicioById(long id) {
		return (Tiposervicio)em.find(Tiposervicio.class, new Long(id));
	}
	/**
	...
	public List<Tiposervicio> findAllTiposervicios() {
        try {
    		String jpqlString = "select tiposervicio from " + Tiposervicio.class.getSimpleName() + " tiposervicio";
	...
	public void persistTiposervicio(Tiposervicio tiposervicio) {
		em.persist(em.merge(tiposervicio));
	}
	/**
