...
/**
 * The DAO class for the Tomasinodroga entity.
 */
@Repository
public class TomaDrogaDAOImpl implements ITomaDrogaDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgresOptica")
    private EntityManager em;

	public TomaDrogaDAOImpl() {
		super();
	}
	/**
	...
	public Tomasinodroga findTomasinodrogaById(long id) {
		return (Tomasinodroga)em.find(Tomasinodroga.class, new Long(id));
	}
	/**
	...
	public List<Tomasinodroga> findAllTomasinodrogas() {
        try {
    		String jpqlString = "select tomasinodroga from " + Tomasinodroga.class.getSimpleName() + " tomasinodroga";
	...
	public void persistTomasinodroga(Tomasinodroga tomasinodroga) {
		em.persist(em.merge(tomasinodroga));
	}
	/**
	...
	public void removeTomasinodroga(Tomasinodroga tomasinodroga) {
		...
		em.remove(em.merge(tomasinodroga));
	}
}