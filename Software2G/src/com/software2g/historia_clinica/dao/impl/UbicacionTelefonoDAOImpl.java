...
/**
 * The DAO class for the Ubicaciontelefono entity.
 */
@Repository
public class UbicacionTelefonoDAOImpl implements IUbicacionTelefonoDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgresOptica")
    private EntityManager em;

	public UbicacionTelefonoDAOImpl() {
		super();
	}
	/**
	...
	public Ubicaciontelefono findUbicaciontelefonoById(long id) {
		return (Ubicaciontelefono)em.find(Ubicaciontelefono.class, new Long(id));
	}
	/**
	...
	public List<Ubicaciontelefono> findAllUbicaciontelefonos() {
        try {
    		String jpqlString = "select ubicaciontelefono from " + Ubicaciontelefono.class.getSimpleName() + " ubicaciontelefono";
	...
	public void persistUbicaciontelefono(Ubicaciontelefono ubicaciontelefono) {
		em.persist(em.merge(ubicaciontelefono));
	}
	/**
	...
	public void removeUbicaciontelefono(Ubicaciontelefono ubicaciontelefono) {
		...
		em.remove(em.merge(ubicaciontelefono));
	}
}