...
/**
 * The DAO class for the Variableformulacion entity.
 */
@Repository
public class VariableFormulacionDAOImpl implements IVariableFormulacionDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgresOptica")
    private EntityManager em;

	public VariableFormulacionDAOImpl() {
		super();
	}
	/**
	...
	public Variableformulacion findVariableformulacionById(long id) {
		return (Variableformulacion)em.find(Variableformulacion.class, new Long(id));
	}
	/**
	...
	public List<Variableformulacion> findAllVariableformulacions() {
        try {
    		String jpqlString = "select variableformulacion from " + Variableformulacion.class.getSimpleName() + " variableformulacion";
	...
	public void persistVariableformulacion(Variableformulacion variableformulacion) {
		em.persist(em.merge(variableformulacion));
	}
	/**
	...
	public void removeVariableformulacion(Variableformulacion variableformulacion) {
		...
		em.remove(em.merge(variableformulacion));
	}
}