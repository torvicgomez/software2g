...
/**
 * The DAO class for the Proveedor entity.
 */
@Repository
public class ProveedorDAOImpl implements IProveedorDao {
	...
	public Proveedor findProveedorById(long id) {
		return (Proveedor)em.find(Proveedor.class, new Long(id));
	}
	/**
	...
	public List<Proveedor> findAllProveedors() {
        try {
    		String jpqlString = "select proveedor from " + Proveedor.class.getSimpleName() + " proveedor";
