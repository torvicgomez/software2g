...
/**
 * The DAO class for the Personainstitucion entity.
 */
@Repository
public class PersonaInstitucionDaoImpl implements IPersonaInstitucionDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgres")
    private EntityManager em;

	public PersonaInstitucionDaoImpl() {
		super();
	}
	/**
	...
	public Personainstitucion findPersonainstitucionById(com.software2g.vo.PersonainstitucionPK id) {
		return (Personainstitucion)em.find(Personainstitucion.class, id);
	}
	/**
	...
	public List<Personainstitucion> findAllPersonainstitucions() {
        try {
    		String jpqlString = "select personainstitucion from " + Personainstitucion.class.getSimpleName() + " personainstitucion";
	...
	public void persistPersonainstitucion(Personainstitucion personainstitucion) {
		em.persist(em.merge(personainstitucion));
	}
	/**
	...
	public void removePersonainstitucion(Personainstitucion personainstitucion) {
		...
		em.remove(em.merge(personainstitucion));
	}
}