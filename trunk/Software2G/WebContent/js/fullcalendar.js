...
function EventManager(options) { // assumed to be a calendar
	...
	function buildEvent(data, source) { // source may be undefined!
		...
		var allDay;
		var allDayDefault;
		//alert('entra esta parte del metodo!!!!!!');
		//alert('data: ['+data+']');
		//alert('data.start: ['+data.start+']');
		//alert('data.end: ['+data.end+']');
...
setDefaults({
	allDaySlot: paca_alldayslot,
	allDayText: paca_alldaytext,
	scrollTime: paca_scrolltime,
	slotDuration: paca_slotduration,
	...
	minTime: paca_mitime,
	maxTime: paca_maxtime,
	slotEventOverlap: paca_sloteventover
});
