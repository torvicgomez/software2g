...
.fondo{
	...
	background-image: -ms-linear-gradient(top, #FFFFFF 0%, #966A36 100%);
	/* Mozilla Firefox */ 
	background-image: -moz-linear-gradient(top, #FFFFFF 0%, #966A36 100%);
	/* Opera */ 
	background-image: -o-linear-gradient(top, #FFFFFF 0%, #966A36 100%);
	/* Webkit (Safari/Chrome 10) */ 
	background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #FFFFFF), color-stop(1, #966A36));
	/* Webkit (Chrome 11+) */ 
