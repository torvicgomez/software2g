...
/**
 * The DAO class for the Tiemponodisponible entity.
 */
@Repository
public class TiempoNoDisponibleJDAOImpl implements ITiempoNoDisponibleDao {
    @PersistenceContext
    private EntityManager em;

	public TiempoNoDisponibleJDAOImpl() {
		super();
	}
	/**
	...
	public Tiemponodisponible findTiemponodisponibleById(long id) {
		return (Tiemponodisponible)em.find(Tiemponodisponible.class, new Long(id));
	}
	/**
	...
	public List<Tiemponodisponible> findAllTiemponodisponibles() {
        try {
    		String jpqlString = "select tiemponodisponible from " + Tiemponodisponible.class.getSimpleName() + " tiemponodisponible";
	...
	public void persistTiemponodisponible(Tiemponodisponible tiemponodisponible) {
		em.persist(em.merge(tiemponodisponible));
	}
	/**
	...
	public void removeTiemponodisponible(Tiemponodisponible tiemponodisponible) {
		...
		em.remove(em.merge(tiemponodisponible));
	}
}