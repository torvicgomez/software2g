...
/**
 * The DAO class for the Antecesentesflia entity.
 */
@Repository
public class AntecedentesFliaDAOImpl implements IAntecedentesFliaDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgresOptica")
    private EntityManager em;

	public AntecedentesFliaDAOImpl() {
		super();
	}
	/**
	...
	public Antecesentesflia findAntecesentesfliaById(long id) {
		return (Antecesentesflia)em.find(Antecesentesflia.class, new Long(id));
	}
	/**
	...
	public List<Antecesentesflia> findAllAntecesentesflias() {
        try {
    		String jpqlString = "select antecesentesflia from " + Antecesentesflia.class.getSimpleName() + " antecesentesflia";
	...
	public void persistAntecesentesflia(Antecesentesflia antecesentesflia) {
		em.persist(em.merge(antecesentesflia));
	}
	/**
	...
	public void removeAntecesentesflia(Antecesentesflia antecesentesflia) {
		...
		em.remove(em.merge(antecesentesflia));
	}
}