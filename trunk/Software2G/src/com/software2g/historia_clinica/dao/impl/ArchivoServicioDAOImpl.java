...
/**
 * The DAO class for the Archivoservicio entity.
 */
@Repository
public class ArchivoServicioDAOImpl implements IArchivoServicioDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgres")
    private EntityManager em;

	public ArchivoServicioDAOImpl() {
		super();
	}
	/**
	...
	public Archivoservicio findArchivoservicioById(long id) {
		return (Archivoservicio)em.find(Archivoservicio.class, new Long(id));
	}
	/**
	...
	public List<Archivoservicio> findAllArchivoservicios() {
        try {
    		String jpqlString = "select archivoservicio from " + Archivoservicio.class.getSimpleName() + " archivoservicio";
	...
	public void persistArchivoservicio(Archivoservicio archivoservicio) {
		em.persist(em.merge(archivoservicio));
	}
	/**
	...
	public void removeArchivoservicio(Archivoservicio archivoservicio) {
		...
		em.remove(em.merge(archivoservicio));
	}
}