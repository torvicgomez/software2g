...
/**
 * The DAO class for the Consulta entity.
 */
@Repository
public class ConsultaDAO implements IConsultaDao {
	...
	public Consulta findConsultaById(long id) {
		return (Consulta)em.find(Consulta.class, new Long(id));
	}
	/**
	...
	public List<Consulta> findAllConsultas() {
        try {
    		String jpqlString = "select consulta from " + Consulta.class.getSimpleName() + " consulta";
