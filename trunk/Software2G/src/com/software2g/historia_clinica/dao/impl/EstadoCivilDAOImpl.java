...
/**
 * The DAO class for the Estadocivil entity.
 */
@Repository
public class EstadoCivilDAOImpl implements IEstadoCivilDao {
    @PersistenceContext
	...
	public Estadocivil findEstadocivilById(long id) {
		return (Estadocivil)em.find(Estadocivil.class, new Long(id));
	}
	/**
	...
	public List<Estadocivil> findAllEstadocivils() {
        try {
    		String jpqlString = "select estadocivil from " + Estadocivil.class.getSimpleName() + " estadocivil";
	...
	public void persistEstadocivil(Estadocivil estadocivil) {
		em.persist(em.merge(estadocivil));
	}
	/**
