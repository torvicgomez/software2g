...
/**
 * The DAO class for the Examen entity.
 */
@Repository
public class ExamenDAOImpl implements IExamenDao {
	...
	public Examen findExamenById(long id) {
		return (Examen)em.find(Examen.class, new Long(id));
	}
	/**
	...
	public List<Examen> findAllExamens() {
        try {
    		String jpqlString = "select examen from " + Examen.class.getSimpleName() + " examen";
