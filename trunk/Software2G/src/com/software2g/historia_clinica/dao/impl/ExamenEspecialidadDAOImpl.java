...
/**
 * The DAO class for the Examenespecialidad entity.
 */
@Repository
public class ExamenEspecialidadDAOImpl implements IExamenEspecialidadDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgres")
    private EntityManager em;

	public ExamenEspecialidadDAOImpl() {
		super();
	}
	/**
	...
	public Examenespecialidad findExamenespecialidadById(long id) {
		return (Examenespecialidad)em.find(Examenespecialidad.class, new Long(id));
	}
	/**
	...
	public void persistExamenespecialidad(Examenespecialidad examenespecialidad) {
		em.persist(em.merge(examenespecialidad));
	}
	/**
	...
	public void removeExamenespecialidad(Examenespecialidad examenespecialidad) {
		...
		em.remove(em.merge(examenespecialidad));
	}
}