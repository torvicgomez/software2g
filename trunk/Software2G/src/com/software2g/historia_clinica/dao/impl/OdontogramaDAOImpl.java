...
/**
 * The DAO class for the Odontograma entity.
 */
@Repository
public class OdontogramaDAOImpl implements IOdontogramaDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgres")
    private EntityManager em;

	public OdontogramaDAOImpl() {
		super();
	}
	/**
	...
	public Odontograma findOdontogramaById(long id) {
		return (Odontograma)em.find(Odontograma.class, new Long(id));
	}
	/**
	...
	public List<Odontograma> findAllOdontogramas() {
        try {
    		String jpqlString = "select odontograma from " + Odontograma.class.getSimpleName() + " odontograma";
	...
	public void persistOdontograma(Odontograma odontograma) {
		em.persist(em.merge(odontograma));
	}
	/**
	...
	public void removeOdontograma(Odontograma odontograma) {
		...
		em.remove(em.merge(odontograma));
	}
}