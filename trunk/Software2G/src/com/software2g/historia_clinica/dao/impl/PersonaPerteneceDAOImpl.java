...
/**
 * The DAO class for the Personapertenece entity.
 */
@Repository
public class PersonaPerteneceDAOImpl implements IPersonaPerteneceDao {
	...
	public Personapertenece findPersonaperteneceById(com.software2g.vo.PersonapertenecePK id) {
		return (Personapertenece)em.find(Personapertenece.class, id);
	}
	/**
	...
	public List<Personapertenece> findAllPersonaperteneces() {
        try {
    		String jpqlString = "select personapertenece from " + Personapertenece.class.getSimpleName() + " personapertenece";
	...
	public void persistPersonapertenece(Personapertenece personapertenece) {
		em.persist(em.merge(personapertenece));
	}
	/**
	...
	public void removePersonapertenece(Personapertenece personapertenece) {
		...
		em.remove(em.merge(personapertenece));
	}
}