...
/**
 * The DAO class for the Registroformulacion entity.
 */
@Repository
public class RegistroFormulacionDAOImpl implements IRegistroFormulacionDao {
    @PersistenceContext
    private EntityManager em;

	public RegistroFormulacionDAOImpl() {
		super();
	}
	/**
	...
	public Registroformulacion findRegistroformulacionById(long id) {
		return (Registroformulacion)em.find(Registroformulacion.class, new Long(id));
	}
	/**
	...
	public List<Registroformulacion> findAllRegistroformulacions() {
        try {
    		String jpqlString = "select registroformulacion from " + Registroformulacion.class.getSimpleName() + " registroformulacion";
	...
	public void persistRegistroformulacion(Registroformulacion registroformulacion) {
		em.persist(em.merge(registroformulacion));
	}
	/**
	...
	public void removeRegistroformulacion(Registroformulacion registroformulacion) {
		...
		em.remove(em.merge(registroformulacion));
	}
}