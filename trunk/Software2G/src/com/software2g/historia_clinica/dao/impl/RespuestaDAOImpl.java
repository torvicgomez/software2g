...
/**
 * The DAO class for the Respuesta entity.
 */
@Repository
public class RespuestaDAOImpl implements IRespuestaDao {
	...
	public Respuesta findRespuestaById(long id) {
		return (Respuesta)em.find(Respuesta.class, new Long(id));
	}
	/**
	...
	public List<Respuesta> findAllRespuestas() {
        try {
    		String jpqlString = "select respuesta from " + Respuesta.class.getSimpleName() + " respuesta";
