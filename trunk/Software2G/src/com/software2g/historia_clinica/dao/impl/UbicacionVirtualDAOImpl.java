...
/**
 * The DAO class for the Ubicacionvirtual entity.
 */
@Repository
public class UbicacionVirtualDAOImpl implements IUbicacionVirtualDao {
	@PersistenceContext(unitName="entityManagerFactoryPostgresOptica")
    private EntityManager em;

	public UbicacionVirtualDAOImpl() {
		super();
	}
	/**
	...
	public Ubicacionvirtual findUbicacionvirtualById(long id) {
		return (Ubicacionvirtual)em.find(Ubicacionvirtual.class, new Long(id));
	}
	/**
	...
	public List<Ubicacionvirtual> findAllUbicacionvirtuals() {
        try {
    		String jpqlString = "select ubicacionvirtual from " + Ubicacionvirtual.class.getSimpleName() + " ubicacionvirtual";
	...
	public void persistUbicacionvirtual(Ubicacionvirtual ubicacionvirtual) {
		em.persist(em.merge(ubicacionvirtual));
	}
	/**
	...
	public void removeUbicacionvirtual(Ubicacionvirtual ubicacionvirtual) {
		...
		em.remove(em.merge(ubicacionvirtual));
	}
}