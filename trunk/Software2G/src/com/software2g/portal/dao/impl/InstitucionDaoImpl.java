...
/**
 * The DAO class for the Institucion entity.
 */
@Repository
public class InstitucionDaoImpl implements IInstitucionDao {
	...
	public Institucion findInstitucionById(java.lang.Integer id) {
		return (Institucion)em.find(Institucion.class, id);
	}
	/**
	...
	public List<Institucion> findAllInstitucions() {
        try {
    		String jpqlString = "select institucion from " + Institucion.class.getSimpleName() + " institucion";
	...
	public void persistInstitucion(Institucion institucion) {
		em.persist(em.merge(institucion));
	}
	/**
	...
	public void removeInstitucion(Institucion institucion) {
		...
		em.remove(em.merge(institucion));
	}
}